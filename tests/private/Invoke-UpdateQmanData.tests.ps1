...
Describe "Invoke-UpdateQmanData function for $moduleName" {
    ...
    It "Should not Throw" {
        ...
        {Invoke-UpdateQmanData -ComponentId 1 -RestServer localhost -Column STATUS_ID -Value 2} | Should -Not -Throw
    ...
    It "Should Throw if the Rest Server cannot be reached.." {
        ...
        Mock -CommandName 'Write-LogLevel' -MockWith {}
        {Invoke-UpdateQmanData -ComponentId 1 -RestServer localhost -Column STATUS_ID -Value 2} | Should -Throw
